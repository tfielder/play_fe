...
const renderResults = (songs) => {
  ...
  $('.search-table').append(`
      <tr class='search-result'>
        <td class='search-td'>${song['track']['track_name']}</td>
        <td>${song['track']['artist_name']}</td>
        <td class='hidden'>${song['track']['album_name']}</td>
        <td class='hidden'>${song['track']['track_rating']}</td>
        <td class='hidden'>${song['track']['track_id']}</td>
        <td class='search-td'><button class='table-button favorite-button' id='${song['track']['track_id']}'>Favorite</button></td>
      </tr>
      `)})}
